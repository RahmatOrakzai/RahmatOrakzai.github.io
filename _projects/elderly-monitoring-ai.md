...
<div style="text-align: center;">
  <img src="/images/skystrm.png" alt="SkyStrm monitoring concept" width="65%">
</div>
...
- Vision-based human activity recognition using deep learning and pose analysis  
- Behavioural pattern modelling for elderly independence monitoring  
- Intelligent anomaly detection for risk identification and fall detection  
- Integration of sensing technologies within smart care environments  
- Edge- and cloud-based architectures for healthcare monitoring systems  
...
[🔗 View Article](https://www.mdpi.com/2227-7080/13/5/184){:target="_blank"}
...
[🔗 View Article](https://ieeexplore.ieee.org/document/10084898){:target="_blank"}
